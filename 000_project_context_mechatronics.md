...
- このノートPCには当初 Thonny が入っていない
- Thonny は管理者権限なしでインストール可能
- 第6回2nd turnでは授業冒頭に Thonny を導入する
- 教員はUSBメモリ等に Thonny インストーラを準備しておく
...
- 2nd turn（C・D）：2026-09-03 に第5回まで実施済み。2026-09-10 に第6回を実施予定で、これを含め残り3回。
...
1. 2026-09-10 第6回2nd turn の実施・資料調整
2. 第7回の授業設計
3. 第8回の授業設計
