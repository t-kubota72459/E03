...
また、第5回では Button A を IRセンサへ置き換え、

> **真鍮ベースが検査位置へ来たことを自動で検出する**

仕組みを作りました。

第6回では、検査装置を実際のFAラインへ取り付け、最後に **Relayの接点信号をPLCへ入力して、既存FA設備へ機能を追加**します。
...
- **ジグ完成＋実コンベア速度で安定検出＋HUSKYLENS配置確認**
...
| 190～200分 | 結果記録・片付け | 到達点と第7回残件を記録 |

※ Cグループは2名、Dグループは3名です。最初の作業は可能な範囲で班内分担して並行して進めます。  
...
> **ここから先は、第8章まで完了した班が進む発展課題。第7回へ継続してよい**
...
1. 第6回2nd turnはC・Dグループ計5名。
2. 第4～5回でRelay→24V警告灯までは確認済み。そこへ戻りすぎない。
...
16. PLC課題は、警告灯ONを発展1、保持＋RESETを発展2、搬送禁止を発展3とする。
